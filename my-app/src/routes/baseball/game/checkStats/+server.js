...
export async function POST({ request }) {
    ...
    if (data.baseball_career_average.length === 0 || average > data.baseball_career_average[0].average) {
        ...
        if (data.baseball_career_average.length === 5) {
            await client.request(gql`mutation UpdateAverage($id: Int!) {
    ...
    //drs
    if (data.baseball_career_defensive_runs_saved.length === 0 || drs > data.baseball_career_defensive_runs_saved[0].average) {
    ...
    //home_runs
    if (data.baseball_career_home_runs.length === 0 || home_runs > data.baseball_career_home_runs[0].average) {
    ...
    //mvps
    if (data.baseball_career_mvps.length === 0 || request.mvps > data.baseball_career_mvps[0].average) {
    ...
    //careerSalary
    if (data.baseball_career_salary.length === 0 || request.totalSalary > data.baseball_career_salary[0].average) {
    ...
    //world_series
    if (data.baseball_career_world_series.length === 0 || request.totalSalary > data.baseball_career_world_series[0].average) {
